...
if (strlen($_SESSION['ofsmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($LastInsertId > 0) {
          echo '<script>alert("Suggested Tour has been added")</script>';
...
?>
    ...
    <head>
        ...
        <title>Add Suggested Tour| Tonga Management System</title>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="review-tab-pro-inner">
                                    <ul id="myTab3" class="tab-review-design">
                                        <li class="active"><a href="add-products.php"><i class="fa fa-pencil" aria-hidden="true"></i> Add Suggested Tour</a></li>
                                    </ul>
                                    <form action="#" method="post" enctype="multipart/form-data">
                                        <?php
                                        $eid = $_GET['editid'];
                                        $sql = "SELECT * from tbltoursuggestion where tbltoursuggestion.ID=:eid";
                                        $query = $dbh->prepare($sql);
